...
def main():
    ...
    np.savetxt(fname='..//..//temp//normal1//KBR1B_2019-01-02_X_02.txt', header="End of YAML header",
               X=np.c_[
                   dd_kbr1b.gps_time.compute().to_numpy()[200: 400],
                   dd_sca1b_d.sca_id.compute().to_numpy()[200: 400],
                   range[200: 400] + phase_centre_proj[200: 400],
                   dd_kbr1b.range_rate.compute().to_numpy()[200: 400],
                   dd_kbr1b.range_accl.compute().to_numpy()[200: 400],
                   dd_kbr1b.iono_corr.compute().to_numpy()[200: 400],
                   dd_kbr1b.lighttime_corr.compute().to_numpy()[200: 400]
               ],
               fmt='%s')

    np.savetxt(fname='..//..//temp//normal1//SCA1B_2019-01-02_A_02.txt', header='End of YAML header',
               X=np.c_[
                   dd_sca1b_c['gps_time'].compute().to_numpy()[1000: 2000],
    ...
    np.savetxt(fname='..//..//temp//normal1//SCA1B_2019-01-02_B_02.txt', header="End of YAML header",
               X=np.c_[
                   dd_sca1b_d['gps_time'].compute().to_numpy()[1000: 2000],
                   dd_sca1b_d['sca_id'].compute().to_numpy()[1000: 2000],
                   dd_sca1b_d['GRACEFO_id'].compute().to_numpy()[1000: 2000],
                   dd_sca1b_d['sca_id'].compute().to_numpy()[1000: 2000],
                   dd_sca1b_d['q1'].compute().to_numpy()[1000: 2000],
                   dd_sca1b_d['q2'].compute().to_numpy()[1000: 2000],
                   dd_sca1b_d['q3'].compute().to_numpy()[1000: 2000],
                   dd_sca1b_d['q4'].compute().to_numpy()[1000: 2000],
               ],
               fmt='%s')
