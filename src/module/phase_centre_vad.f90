module phase_centre_vad
    ...
    type, public :: satellite
        ...
        real(kind=wp)                                        :: inverse_vector(4, 6)
...
contains
    ...
    subroutine acc_grav(self)
        ...
        open(unit=output_unit, file='..//temp//acc_grav.txt', iostat=ios, status="unknown", action="write")
    ...
    subroutine divide_jd(self, jd_i, index_span)
        ...
        assign_jd_loop: do i = 1, 4, 1
            ...
            !> solve equations
            !> time domain LSQR
            ! call jd_i(i)%solve_phase_centre_vad_eq(i)
            ! call jd_i(i)%solve_phase_centre_vad_eq_stitch(i)
            !> frequency domain LSQR
            ! call jd_i(i)%solve_phase_centre_vad_eq_freq(i)
