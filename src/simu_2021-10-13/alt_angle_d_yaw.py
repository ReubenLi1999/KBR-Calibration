...
def main():
    ...
    plt.show()
    np.savetxt(fname='..//..//temp//normal1//KBR1B_2019-01-02_X_03.txt', header="End of YAML header",
               X=np.c_[
    ...
    np.savetxt(fname='..//..//temp//normal1//SCA1B_2019-01-02_B_03.txt', header='End of YAML header',
               X=np.c_[
    ...
    np.savetxt(fname='..//..//temp//normal1//SCA1B_2019-01-02_A_03.txt', header="End of YAML header",
               X=np.c_[
