subroutine data_segement_M05(number_data, leapsecond, JD_TT)
...
!-------------------------------
    ...
    call get_year_M05(JD_TT(1), leapsecond(1), year_UTC_1)
    N_temporary = 0
    j = 1
    do i = 1, number_data
        call get_year_M05(JD_TT(i), leapsecond(i), year_UTC_2)
...
end subroutine data_segement_M05