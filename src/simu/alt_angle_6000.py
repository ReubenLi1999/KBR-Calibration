...
def main():
    ...
    alt_angle_sin = np.deg2rad(2 + 1 * np.sin(2. * np.pi / 250. * dd_sca1b_c.gps_time.compute().to_numpy()[0: 6000]))
    ...
    np.savetxt(fname='..//..//temp//simu6000//eqa.txt', X=eqa, fmt="%.18e")
    ...
    # plt.show()
    np.savetxt(fname='..//..//temp//gfo6000//eqb.txt', fmt='%.18e', X=phase_centre_proj + dd_kbr1b.biased_range.compute().to_numpy()[0: 1200] - dd_kbr1b.lighttime_corr.compute().to_numpy()[0: 1200] - range)
    np.savetxt(fname='..//..//temp//simu6000//ant_phase_centre_corr_2degree.txt', fmt='%.18e', X=phase_centre_proj)
    ...
    np.savetxt(fname='..//..//temp//simu6000//KBR1B_2019-01-01_X_56.txt', header="End of YAML header",
               X=np.c_[
    ...
    np.savetxt(fname='..//..//temp//simu6000//SCA1B_2019-01-01_A_05.txt', header='End of YAML header',
               X=np.c_[
    ...
    np.savetxt(fname='..//..//temp//simu6000//SCA1B_2019-01-01_B_05.txt', header="End of YAML header",
               X=np.c_[
    ...
    np.savetxt(fname='..//..//temp//gfo6000//KBR1B_2019-01-01_X_56.txt', header="End of YAML header",
               X=np.c_[
                   dd_kbr1b.gps_time.compute().to_numpy()[0: 1200],
                   dd_sca1b_d.sca_id.compute().to_numpy()[0: 1200],
    ...
    np.savetxt(fname='..//..//temp//gfo6000//SCA1B_2019-01-01_A_05.txt', header='End of YAML header',
               X=np.c_[
                   dd_sca1b_c['gps_time'].compute().to_numpy()[0: 6000],
                   dd_sca1b_c['sca_id'].compute().to_numpy()[0: 6000],
                   dd_sca1b_c['GRACEFO_id'].compute().to_numpy()[0: 6000],
    ...
    np.savetxt(fname='..//..//temp//gfo6000//SCA1B_2019-01-01_B_05.txt', header="End of YAML header",
               X=np.c_[
                   dd_sca1b_d['gps_time'].compute().to_numpy()[0: 6000],
                   dd_sca1b_d['sca_id'].compute().to_numpy()[0: 6000],
                   dd_sca1b_d['GRACEFO_id'].compute().to_numpy()[0: 6000],
